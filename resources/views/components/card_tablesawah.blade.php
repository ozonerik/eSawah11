                        ...
                        <tr class="@if($this->is_checked($row->id)) table-primary @endif">
                            ...
                            @foreach($tbody as $val)
                                <td>
                                    ...
                                    <!--luas-->
                                    @elseif($val=="luas")
                                        {{ get_conluas($row->$val) }} ( {{ get_conbata($row->$val) }} )
                                    <!--harga-->
                            ...
                            <td>
                                ...
                                <button wire:click="onDelete({{ $row->id }})" class="btn btn-sm btn-danger" style="width:35px" data-toggle="tooltip" title="Hapus"><i class="fas fa-trash-alt"></i></button>
                                @endif
                            </td>
                        </tr>
                        @endforeach
