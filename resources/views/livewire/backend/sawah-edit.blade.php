@push('js')
<x-script_map dispatchname="getLokasiSaatini" geoalertId="alert" eventDrag="getDragData" eventMeasure="getMeasureData" ac="ac" lt="lt" lg="lg" autoalamat="lokasi" mapid="mapeditsawah" area="mluas" length="mkel" />
@endpush
<div>
