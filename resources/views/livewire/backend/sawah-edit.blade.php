@push('js')
<x-script_map eventCurrent="getCurrentLoc" eventPlace="changePlace" dispatchname="getLokasiSaatini" geoalertId="alert" eventDrag="getDragData" eventMeasure="getMeasureData" ac="ac" lt="lt" lg="lg" autoalamat="lokasi" mapid="mapeditsawah" area="mluas" length="mkel" />
@endpush
<div>
    ...
    <div class="row mx-1">
        <x-card_form name="Edit Sawah" width="12" order="1" smallorder="1" closeto="onRead">
            <h4>Edit Sawah</h4>
            <x-slot:footer>
            <form wire:submit.prevent="editsawah">
                ...
                <div wire:ignore id="mapeditsawah" style="height: 400px;" class="w-100 rounded bg-blank mb-3"></div>
                ...
                <x-input_mask typemask="noppbb" disabled="" ids="nop" label="NOP" types="text" name="nop" placeholder="Type Nomor Objek Pajak" />
